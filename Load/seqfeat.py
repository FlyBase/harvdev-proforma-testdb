def add_seqfeat_data(cursor, cvterm_id, organism_id, dbxref_id, pub_id, db_id, feature_id):
    ...
    frp_sql = """ INSERT INTO feature_relationshipprop (feature_relationship_id, type_id, value, rank) VALUES (%s, %s, %s, %s) RETURNING  feature_relationshipprop_id"""
    ...
    for i in range(9):
        ...
        # seqfeature-X [symbol,fullname], is_current FALSE
