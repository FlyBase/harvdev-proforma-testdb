...
cv_cvterm = {'FlyBase': ['FlyBase analysis'],
             ...
             'pubprop type': ['curated_by', 'languages', 'perscommtext', 'cam_flag', 'harv_flag'],
...
# create pubs
pub_id = 0
pub_sql = """ INSERT INTO pub (type_id, title, uniquename) VALUES (%s, %s, %s) RETURNING pub_id """
pubprop_sql = """ INSERT INTO pubprop (pub_id, type_id, value, rank) VALUES (%s, %s, %s, %s) """
cursor.execute( pub_sql, (cvterm_id['computer file'], 'Nature', 'FBrf0000001'))
pub_id = cursor.fetchone()[0]
cursor.execute( pubprop_sql, (pub_id, cvterm_id['curated_by'], "Curator:bob McBob....", pub_id))

cursor.execute( pub_sql, (cvterm_id['unattributed'], 'unattributed', 'unattributed'))
pub_id = cursor.fetchone()[0]
cursor.execute( pubprop_sql, (pub_id, cvterm_id['curated_by'], "Curator:bob McBob....", pub_id))

for fly_ref in ('FBrf0104946', 'FBrf0105495'):
    cursor.execute( pub_sql, (cvterm_id['FlyBase analysis'], 'predefined pubs {}'.format(fly_ref[:3]), fly_ref))
    pub_id = cursor.fetchone()[0]
    cursor.execute( pubprop_sql, (pub_id, cvterm_id['curated_by'], "Curator:bob McBob....", pub_id))
